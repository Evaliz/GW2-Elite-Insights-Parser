...
namespace GW2EIParser.Setting
{
    public partial class SettingsForm : Form
    {
        ...
        private void SetValues()
        {
            ...
            UploadEva_check.Checked = Properties.Settings.Default.UploadToEva;
        ...
        private void UploadEva_check_CheckedChanged(object sender, EventArgs e)
        {
            Properties.Settings.Default.UploadToEva = UploadEva_check.Checked;
        }
